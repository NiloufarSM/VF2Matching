 ...
 * Constructor
 ---------------------------------------------------------*/
template<class Node, class Edge>
StreamARGLoader<Node, Edge>::StreamARGLoader(Allocator<Node> *nalloc,
		Allocator<Edge> *ealloc, istream &in) {
 ...
 * Reads a line from the input stream
 ----------------------------------------------------*/
template<class Node, class Edge>
void StreamARGLoader<Node, Edge>::readLine(istream &in, char *line) {
	char *p;
	do {
		*line = '\0';
		if (!in.good())
 ...
 * Reads an int from a line
 ----------------------------------------------------*/
template<class Node, class Edge>
int StreamARGLoader<Node, Edge>::readCount(istream &in) {
 ...
 * Reads a node from a line
 ----------------------------------------------------*/
template<class Node, class Edge>
void StreamARGLoader<Node, Edge>::readNode(Allocator<Node> *alloc,
		istream &in) {
	char line[MAX_LINE + 1];
	readLine(in, line);
	istrstream is(line);
 ...
 * Reads an edge from a line
 ----------------------------------------------------*/
template<class Node, class Edge>
void StreamARGLoader<Node, Edge>::readEdge(Allocator<Edge> *alloc,
		istream &in) {
	char line[MAX_LINE + 1];
	readLine(in, line);
	istrstream is(line);
 ...
 * Node and Edge types
 ----------------------------------------------------------*/
template<class Node, class Edge>
void StreamARGLoader<Node, Edge>::write(ostream &out, ARGraph<Node, Edge> &g) {
 ...
 * Node and Edge types
 ----------------------------------------------------------*/
template<class Node, class Edge>
void StreamARGLoader<Node, Edge>::write(ostream &out, ARGLoader &g) {
	out << g.NodeCount() << endl;
